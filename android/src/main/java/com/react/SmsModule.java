...
//                 PendingIntent sentIntent = PendingIntent.getBroadcast(mActivity, 0, new Intent("SENDING_SMS"), PendingIntent.FLAG_MUTABLE);
                PendingIntent sentIntent=null;
                        if(android.os.Build.VERSION.SDK_INT>=android.os.Build.VERSION_CODES.S){
                        sentIntent=PendingIntent.getBroadcast
                        (mActivity,0,new Intent("SENDING_SMS"),PendingIntent.FLAG_MUTABLE);
                        }
                        else{
                        sentIntent=PendingIntent.getBroadcast
                        (mActivity,0,new Intent("SENDING_SMS"),0);
                        }
...
//                 PendingIntent sentIntent = PendingIntent.getActivity(mActivity, 0, new Intent("android.intent.action.VIEW"), PendingIntent.FLAG_MUTABLE);
                 PendingIntent sentIntent=null;
                        if(android.os.Build.VERSION.SDK_INT>=android.os.Build.VERSION_CODES.S){
                        sentIntent=PendingIntent.getActivity
                        (mActivity,0,new Intent("android.intent.action.VIEW"),PendingIntent.FLAG_MUTABLE);
                        }
                        else
                        {
                        sentIntent=PendingIntent.getActivity
                        (mActivity,0,new Intent("android.intent.action.VIEW"),0);
                        }
...
//             PendingIntent sentPI = PendingIntent.getBroadcast(context, 0, new Intent(SENT), 0);
             PendingIntent sentPI=null;
                                    ...
                                    (context,0,new Intent(SENT),PendingIntent.FLAG_MUTABLE);
                                    }
                                    else
                                    {
                                    sentPI=PendingIntent.getBroadcast
                                    (context,0,new Intent(SENT),0);
                                    }
...
//             PendingIntent deliveredPI = PendingIntent.getBroadcast(context, 0, new Intent(DELIVERED), 0);
            PendingIntent deliveredPI=null;
                                    ...
                                    (context,0,new Intent(DELIVERED),PendingIntent.FLAG_MUTABLE);
                                    }
                                    else
                                    {
                                    deliveredPI=PendingIntent.getBroadcast
